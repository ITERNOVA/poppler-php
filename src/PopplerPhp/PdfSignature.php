...
use Iternova\PopplerPhp\PopplerOptions\DateFlags;
use Iternova\PopplerPhp\PopplerOptions\EncodingOptions;
use Iternova\PopplerPhp\PopplerOptions\InfoFlags;
 ...
 */
class PdfSignature extends PopplerUtil {
